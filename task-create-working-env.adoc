...
.. Select *Discover*.
+
image:screenshot_add_cvs_gcp_credentials.png[A screenshot of adding credentials for a Google Cloud NetApp Volumes subscription.]

.Result

BlueXP displays your Google Cloud NetApp Volumes working environment.

image:screenshot_cvs_gcp_cloud.png[A screenshot of Google Cloud NetApp Volumes Service working environment.]
